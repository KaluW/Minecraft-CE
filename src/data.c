...
// dead bushes are interesting. Treat it like a sheep (use shears), and it will drop a dead bush, otherwise 0-2 sticks. Baaaaa Baaaa Black Sheep...
...
block_t blocks[MAX_BLOCK_TILE_COUNT] = {
	...
	[SAND] = {
		...
		.hardness = 2,
		.onClick = NULL,
		.onUpdate = gravityBlock_onUpdate
	},
	[SANDSTONE] = {
		.yield = SANDSTONE,
		.required_tool = WOODEN_PICKAXE,
	...
	[CACTUS] = {
		...
		.best_tool = None,
		.hardness = 3,
		.onClick = equalToolEffic_onClick,
		.onUpdate = NULL
	},
	[CRAFTING_TABLE] = {
		.yield = CRAFTING_TABLE,
		.required_tool = NO_TOOL,
		.best_tool = Axe,
		.hardness = 12,
		.onClick = craftingTable_onClick,
		.onUpdate = NULL
	},
	[CHEST] = {
		.yield = CHEST,
	...
	[FLOWER_YELLOW] = {
		...
		.hardness = NO_HARDNESS,
		.onClick = NULL,
		.onUpdate = waterPresence_onUpdate
	},
	[FLOWER_RED] = {
		.yield = FLOWER_RED,
		.required_tool = NO_TOOL,
	...
	[WATER] = {
		...
		.best_tool = None,
		.hardness = NO_HARDNESS,
		.onClick = water_onClick,
		.onUpdate = water_onUpdate
	},
	[LAVA] = {
		.yield = NO_YIELD,
		.required_tool = NO_TOOL,
		.best_tool = None,
		.hardness = NO_HARDNESS,
		.onClick = lava_onClick,
		.onUpdate = lava_onUpdate
	}
};
